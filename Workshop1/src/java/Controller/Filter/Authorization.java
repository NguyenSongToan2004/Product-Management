...
public class Authorization implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        int role = (Integer) ses.getAttribute("role");
        String url = req.getServletPath().trim();
        // 0 : staff , 2 : customer , admin : 1
        if (url.equals("/update")) {
            if (role == 0 || role == 2) {
                ...
                if (req.getParameter("action") == null) {
                    res.sendRedirect("update?action=update");
                }
            }
            ...
            if (role == 2 || role == 0) {
                ...
                if (req.getParameter("action") == null) {
                    res.sendRedirect("MainController?action=Dashboard&&action2=Dashboard");
                }
            }
        }
